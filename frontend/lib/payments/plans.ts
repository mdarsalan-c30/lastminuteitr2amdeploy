...
export const PLANS: Record<PlanId, Plan> = {
  ...
  normal: {
    ...
    price: 349,
    priceLabel: "₹349",
    description: "For straightforward salaried returns",
    recommended: false,
    buttonText: "Choose Essential",
    features: [
      "Form 16 upload & review",
      "Salary and employer-TDS summary",
      "Old vs new tax-regime comparison",
      "Missing-information checklist",
      "Filing summary",
      "Screen-by-screen Income Tax Portal guide",
    ],
  },
  pro: {
    id: "pro",
    ...
    price: 599,
    priceLabel: "₹599",
    description: "For investments, trading and additional income",
    recommended: true,
    buttonText: "Choose Guided",
    features: [
      "Everything in Essential",
      "Guided questions based on income sources",
      "Supported capital-gain statement review",
      "Trading-information checklist",
      "Additional income and tax-credit checks",
